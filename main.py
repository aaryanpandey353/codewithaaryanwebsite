...
app.config['MONGO_URI'] = 'mongodb+srv://codewithaaryan:aaryanpandey@codewithaaryan.vs9hghh.mongodb.net/mydatabase'
mongo = PyMongo(app)
...
def codeeditor():
    return render_template("/sourcecode/index.html")
...
@app.route('/courses/python video/video/')
def pytohnvideo():
  return render_template('/courses/python video/video/index.html')

@app.route('/courses/python video/video1/')
def pytohnvideo1():
  return render_template('/courses/python video/video1/index.html')

@app.route('/courses/python video/video2/')
def pytohnvideo2():
  return render_template('/courses/python video/video2/index.html')

@app.route('/courses/python video/video3/')
def pytohnvideo3():
  return render_template('/courses/python video/video3/index.html')
